...
export type CryptoPoolDeployedEventFilter =
  TypedEventFilter<CryptoPoolDeployedEvent>;
...
export type UpdateTokenImplementationEvent = TypedEvent<
  [string, string],
  { _old_token_implementation: string; _new_token_implementation: string }
>;

export type UpdateTokenImplementationEventFilter =
  TypedEventFilter<UpdateTokenImplementationEvent>;

export type UpdateGaugeImplementationEvent = TypedEvent<
  [string, string],
  { _old_gauge_implementation: string; _new_gauge_implementation: string }
>;

export type UpdateGaugeImplementationEventFilter =
  TypedEventFilter<UpdateGaugeImplementationEvent>;
